...
export default function WorkDetailsSheet({ work, onClose, onSpeak, commandsMap, currentExpertise, setCurrentExpertise, currentLength, setCurrentLength, socket, roomCode, isSharedSession, isTeacher, playMode }) {
