...
export default function NavigationControlBar({
  ...
  return (
    <div className="w-full shrink-0 bg-[#09090b]/90 border-t border-slate-800 flex flex-col p-3 md:px-6 gap-3 z-[999] backdrop-blur-xl shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
