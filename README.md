...
#### Divisione directory;
  - src -> backend
    - js/controllers -> relazione con mongodb
  ...
  - public -> frontend
    - js -> renderizzazione globale sul browser

#### Cose da fare:
  - pensare agli schemi delle visite
    - API lista di opere -> per la mappa statica
    - eventualmente anches stanza per mappa dinamica
...
#### Prossime idee:
  - il qr code puo' servire per dire "dove sei?"
